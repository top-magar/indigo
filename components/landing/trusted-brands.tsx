            ...
            <div className="max-w-7xl mx-auto px-4 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-x-12 gap-y-10 opacity-70 hover:opacity-100 transition-opacity duration-500 grayscale hover:grayscale-0 items-center">
                    ...
                    <div className="h-8 md:h-10 w-auto group flex items-center gap-2">
                        <svg viewBox="0 0 150 40" className="h-full w-auto" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="20" cy="20" r="15" className="fill-foreground group-hover:fill-[#00A651] transition-colors" />
                            <text x="12" y="26" fontFamily="sans-serif" fontWeight="bold" fontSize="16" fill="white">P</text>
                            <text x="45" y="26" fontFamily="sans-serif" fontWeight="800" fontSize="20" className="fill-foreground group-hover:fill-[#00A651] transition-colors">Pathao</text>
                        </svg>
                    </div>

                    {/* Foodmandu Logo */}
                    <div className="h-8 md:h-10 w-auto group flex items-center gap-2">
                        <svg viewBox="0 0 180 40" className="h-full w-auto" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="20" cy="20" r="15" className="fill-foreground group-hover:fill-[#E53935] transition-colors" />
                            <text x="15" y="25" fontFamily="sans-serif" fontWeight="bold" fontSize="14" fill="white">F</text>
                            <text x="45" y="26" fontFamily="sans-serif" fontWeight="800" fontSize="18" className="fill-foreground group-hover:fill-[#E53935] transition-colors">Foodmandu</text>
                        </svg>
                    </div>
