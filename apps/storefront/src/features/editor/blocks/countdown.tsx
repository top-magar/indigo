...
import { Section, TextField, ColorField, SegmentedControl } from "../controls/editor-fields"
...
CountdownBlock.craft = {
  ...
  props: { _v: 1, targetDate: defaultTarget(), heading: "Sale Ends In", expiredText: "This offer has expired", variant: "card" as const, backgroundColor: "#0f172a", textColor: "#ffffff", accentColor: "#ef4444", paddingTop: 48, paddingBottom: 48, hideOnDesktop: false, _scrollEffect: "none", _shadow: "none", _opacity: 100, _blur: 0, _borderRadius: 0, _sticky: "none", hideOnTablet: false, hideOnMobile: false },
