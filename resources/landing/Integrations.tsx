...
import { ArrowRight, CreditCard, Truck, MessageCircle, Share2, Code2 } from 'lucide-react';
import { Button } from '@/shared/components/ui/button';
import { cn } from '@/lib/utils';

export const Integrations = () => {
   return (
      <section id="integrations" className="py-24 bg-background relative overflow-hidden border-y border-border scroll-mt-28">
         {/* Header */}
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 text-center relative z-10">
            <h2 className="text-3xl sm:text-5xl font-bold text-foreground mb-6 tracking-tight">
               Plays Nice with <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-600">Everything</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
               Connect Pasaal to the tools that power your business. From local wallets to global marketing platforms.
            </p>
         </div>
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-12 gap-6 relative z-10">
            ...
            <div className="md:col-span-7 group relative rounded-3xl border border-border bg-card overflow-hidden min-h-[400px] flex flex-col hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-500">
                        ...
                        <div className="space-y-3">
                           ...
                           <div className="flex items-center justify-between p-3 rounded-xl border border-green-200 dark:border-green-900 bg-green-50 dark:bg-green-900/20 hover:bg-green-100 transition-colors cursor-pointer group/item">
                              <div className="flex items-center gap-3">
                                 ...
                                 <span className="font-medium text-green-900 dark:text-green-100">Pay with eSewa</span>
                              </div>
                              <div className="w-4 h-4 rounded-full border-2 border-green-500 flex items-center justify-center">
                                 <div className="w-2 h-2 rounded-full bg-green-500 opacity-0 group-hover/item:opacity-100 transition-opacity"></div>
                              </div>
                           </div>
                           {/* Khalti Option */}
                           <div className="flex items-center justify-between p-3 rounded-xl border border-purple-200 dark:border-purple-900 bg-purple-50 dark:bg-purple-900/20 hover:bg-purple-100 transition-colors cursor-pointer group/item">
                              <div className="flex items-center gap-3">
                                 ...
                                 <span className="font-medium text-purple-900 dark:text-purple-100">Pay with Khalti</span>
                              </div>
                           ...
                           <div className="flex items-center justify-between p-3 rounded-xl border border-border hover:bg-muted transition-colors cursor-pointer opacity-60">
                              <div className="flex items-center gap-3">
                                 <div className="w-10 h-10 rounded-lg bg-blue-600 flex items-center justify-center text-white"><CreditCard className="w-5 h-5" /></div>
            ...
            {/* Card 2: Logistics (Medium, 5 cols) */}
            <div className="md:col-span-5 group relative rounded-3xl border border-border bg-card overflow-hidden min-h-[400px] flex flex-col hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-500">
