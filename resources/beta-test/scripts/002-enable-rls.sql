...
-- Allow tenant creation during onboarding (before user has tenant_id set)
...
-- Public read access for active products on storefront
...
-- Public insert for customer registration on storefront
