...
import { useEditorStore, selectBlocks, selectSelectedBlockId, selectSelectedBlockIds, selectHoveredBlockId, selectViewport, selectEditorMode, selectActiveDragId, selectOverBlockId, selectActiveGuides, selectSnappingEnabled } from "@/lib/editor/store"
...
import { BLOCK_ICONS, BLOCK_TEXT_COLORS, BLOCK_BG_COLORS } from "@/lib/editor/block-constants"
import { EditorCartProvider } from "@/lib/store/editor-cart-provider"
import { AnimatedDropIndicator } from "@/components/editor/animated-drop-indicator"
import { BlockGhostPreview } from "@/components/editor/block-ghost-preview"
import { SmartGuides } from "@/components/editor/smart-guides"
import { ResizeHandles } from "@/components/editor/resize-handles"
import { isResizableBlock, getResizeCapabilities } from "@/lib/editor/hooks/use-block-resize"
import { calculateGuides, getAllBlockBounds, getBlockBounds } from "@/lib/editor/guides"
    ...
    >
      ...
      {(isSelected || isHovered) && !isCurrentlyDragging && (
        <div className="absolute -top-7 right-2 z-50">
          <BlockActionBar position="top" className="py-0.5 px-1">
            <BlockActions
              onMoveUp={onMoveUp}
