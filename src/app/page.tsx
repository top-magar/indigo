    ...
    <div className="min-h-screen bg-white text-[#1a1a1a]" style={{ fontFamily: "'Archivo', sans-serif" }}>
      ...
      <section id="features" className="py-16 px-5 md:px-10 lg:px-20">
        <div className="max-w-[1440px] mx-auto flex flex-col items-center gap-16">
          <div><SectionHeading tag="FEATURES" title="Smarter Tools to Grow Your Store" description="Everything you need to sell online in Nepal — payments, shipping, analytics, and more." /></div>
      ...
      <section id="pricing" className="py-16 px-5 md:px-10 lg:px-20">
        <div className="max-w-[1440px] mx-auto flex flex-col items-center gap-16">
          <div><SectionHeading tag="PRICING PLANS" title="Flexible Pricing for Every Stage" description="Start free. Upgrade as you grow. No transaction fees from Indigo." /></div>
      ...
      <section className="py-16 px-5 md:px-10 lg:px-20">
        <div className="max-w-[1440px] mx-auto flex flex-col items-center gap-16">
          <div><SectionHeading tag="BENEFITS" title="Why 12,000+ Merchants Choose Indigo" description="The advantages that make selling online in Nepal actually work." /></div>
      ...
      <section className="py-16 px-5 md:px-10 lg:px-20">
        <div className="max-w-[1440px] mx-auto flex flex-col items-center gap-16">
          <div><SectionHeading tag="TESTIMONIALS" title="Trusted by Merchants Across Nepal" description="Real stories from real businesses growing with Indigo." /></div>
