...
import {
  ...
  Globe, User, Users, Bell, MessageCircle, Wallet, ShieldCheck,
} from "lucide-react";
...
const sections = [
  ...
  { label: "Account", items: [
    ...
    { title: "Verification", href: "/dashboard/settings/verification", icon: ShieldCheck, description: "KYC and identity" },
