...
export default async function OrderDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const transformedOrder = {
    ...
    customer: {
      ...
      avatarUrl: (customer as Record<string, unknown>)?.avatar_url as string | undefined,
      isGuest: !order.customer_id,
      totalOrders: (customer as Record<string, unknown>)?.orders_count as number | undefined,
      totalSpent: (customer as Record<string, unknown>)?.total_spent ? parseFloat(String((customer as Record<string, unknown>).total_spent)) : undefined,
    },
