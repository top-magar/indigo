  ...
  integrations: {
    ...
    rows: [
      [
        ...
        { id: "fonepay", name: "FonePay", category: "Payments" },
        { id: "stripe", name: "Stripe", category: "Payments" },
        { id: "paypal", name: "PayPal", category: "Payments" },
        { id: "nabil", name: "Nabil Bank", category: "Banking" },
        { id: "nic-asia", name: "NIC Asia", category: "Banking" },
        { id: "global-ime", name: "Global IME Bank", category: "Banking" },
        { id: "everest", name: "Everest Bank", category: "Banking" },
        { id: "pathao", name: "Pathao", category: "Shipping" },
        { id: "dt-express", name: "DT Express", category: "Shipping" },
        { id: "nepal-post", name: "Nepal Post", category: "Shipping" },
