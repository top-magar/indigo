...
import { MoreHorizontalIcon, PencilEdit01Icon, Delete02Icon, GridIcon } from "@hugeicons/core-free-icons"
      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-12">
          <div className="h-16 w-16 rounded-2xl bg-muted/50 flex items-center justify-center">
            <HugeiconsIcon icon={GridIcon} className="h-8 w-8 text-muted-foreground/50" />
          </div>
