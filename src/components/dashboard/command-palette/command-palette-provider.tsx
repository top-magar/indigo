  ...
  React.useEffect(() => {
    ...
    const defaultCommands: CommandPaletteCommand[] = [
      ...
      },
      {
        ...
        icon: TrendingUp,
        shortcut: ["g", "a"],
        keywords: ["reports", "stats", "metrics", "insights", "finances", "revenue"],
        group: "navigation",
      ...
      },
      {
        ...
        description: "Manage campaigns and discounts",
        icon: TrendingUp,
        shortcut: ["g", "m"],
        keywords: ["campaigns", "discounts", "promotions", "coupons", "gift cards"],
        group: "navigation",
        onSelect: () => router.push(`${basePath}/marketing`),
      },
      {
        id: "nav-inventory",
