...
export function LogoCloud({ heading, logos, variant, columns }: LogoCloudProps) {
  ...
  return (
    <div className="py-12 px-6 text-center">
      {heading && <h2 className="mb-8 text-2xl" style={{ fontFamily: "var(--store-font-heading, Inter, sans-serif)", fontWeight: "var(--store-heading-weight, 700)", color: "var(--store-color-text, #0f172a)" }}>{heading}</h2>}
      {variant === "marquee" ? (
