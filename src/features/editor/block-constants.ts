...
export const BLOCK_COLORS: Record<BlockType, { text: string; bg: string; border: string }> = {
  ...
  "contact-info": { text: "text-cyan-500", bg: "bg-cyan-500", border: "border-cyan-500" },
}
...
export const BLOCK_PALETTE_COLORS: Record<BlockType, string> = {
  ...
  "contact-info": "bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 group-hover:bg-cyan-500/20",
}
...
export const BLOCK_HOVER_COLORS: Record<BlockType, string> = {
  ...
  "contact-info": "bg-cyan-500/10 group-hover:bg-cyan-500/20",
}
