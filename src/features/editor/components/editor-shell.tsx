            ...
            <div className="p-8" style={{ zoom: zoom }}>
              ...
              >
                <Frame json={craftJson ?? undefined}>
                  <Element canvas is={Container} {...({} as any)}>
                    <TextBlock {...{ text: "Welcome to your store", fontSize: 32, color: "#000", alignment: "center", tagName: "h1" } as any} />
                    <TextBlock {...{ text: "Start building by dragging blocks from the Add Section button", fontSize: 16, color: "#666", alignment: "center", tagName: "p" } as any} />
                  </Element>
                </Frame>
              </div>
            </div>
