...
register({ type: 'heading', name: 'Heading', icon: Heading1, color: '#3b82f6', group: 'Basic', isContainer: false,
...
register({ type: 'subheading', name: 'Subheading', icon: Heading2, color: '#60a5fa', group: 'Basic', isContainer: false,
...
register({ type: 'text', name: 'Paragraph', icon: Type, color: '#3b82f6', group: 'Basic', isContainer: false,
  factory: () => ({ id: v4(), type: 'text', name: 'Text', styles: { fontSize: '16px', width: '100%' }, content: { innerText: 'Edit this text' } }) });

register({ type: 'list', name: 'List', icon: List, color: '#06b6d4', group: 'Basic', isContainer: false,
  factory: () => ({ id: v4(), type: 'list', name: 'List', styles: { padding: '0 0 0 20px', fontSize: '16px', lineHeight: '1.8' }, content: { innerText: 'First item\nSecond item\nThird item' } }) });

register({ type: 'quote', name: 'Quote', icon: Quote, color: '#f59e0b', group: 'Basic', isContainer: false,
...
register({ type: 'badge', name: 'Badge', icon: Star, color: '#eab308', group: 'Basic', isContainer: false,
...
register({ type: 'code', name: 'Code', icon: Code, color: '#10b981', group: 'Basic', isContainer: false,
...
register({ type: 'icon', name: 'Icon', icon: Star, color: '#ec4899', group: 'Basic', isContainer: false,
