...
register({ type: 'video', name: 'Video', icon: Video, color: '#ef4444', group: 'Media', isContainer: false,
...
register({ type: 'button', name: 'Button', icon: CheckSquare, color: '#2563eb', group: 'Basic', isContainer: false,
