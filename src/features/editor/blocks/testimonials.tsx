...
export const TestimonialsBlock = (props: TestimonialsProps) => {
  ...
  if (variant === "large-quote") {
    ...
    return (
      <div ref={craftRef(connect, drag)} style={{ background: backgroundColor || undefined, padding: `${paddingTop}px var(--store-section-gap-h, 24px) ${paddingBottom}px`, textAlign: "center" }}>
