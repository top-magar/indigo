...
import { addCustomerNoteAction, deleteCustomerNote } from "@/app/dashboard/customers/customer-actions";
import type { Customer, CustomerNote } from "@/app/dashboard/customers/types";
