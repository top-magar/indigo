...
export function RelatedProducts({
  ...
  return (
    <section className={className}>
      <h2 className="mb-6 text-xl font-semibold tracking-[-0.4px] text-foreground">
        {title}
      </h2>
            ...
            <div className="space-y-3">
              <div className="relative aspect-square overflow-hidden rounded-lg bg-muted">
                ...
                {product.compareAtPrice && (
                  <span className="absolute left-2 top-2 rounded-sm bg-destructive px-2 py-1 text-xs font-medium text-white">
                    Sale
                  </span>
                )}
              </div>
