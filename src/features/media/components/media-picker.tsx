...
import { formatFileSize, getFileTypeCategory, validateFile } from "@/features/media/types";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-2 opacity-0 group-hover:opacity-100 transition-opacity">
        <p className="text-xs text-primary-foreground truncate">{asset.filename}</p>
        <p className="text-xs text-primary-foreground/70">{formatFileSize(asset.sizeBytes)}</p>
      </div>
    </button>
  );
}
