...
const statusConfig: Record<OrderStatus, { color: string; bgColor: string; label: string }> = {
    ...
    processing: { color: "text-info", bgColor: "bg-info/10", label: "Processing" },
    shipped: { color: "text-shipping", bgColor: "bg-shipping/10", label: "Shipped" },
...
const paymentStatusConfig: Record<PaymentStatus, { color: string; bgColor: string; label: string }> = {
    ...
    partially_paid: { color: "text-info", bgColor: "bg-info/10", label: "Partial" },
    partially_refunded: { color: "text-info", bgColor: "bg-info/10", label: "Partial Refund" },
...
const fulfillmentStatusConfig: Record<FulfillmentStatus, { color: string; bgColor: string; label: string }> = {
    ...
    partially_fulfilled: { color: "text-info", bgColor: "bg-info/10", label: "Partial" },
