...
import type { Order, OrderLine } from "@/features/orders/types";
        ...
        <Card>
            ...
            <CardContent className="p-0">
                ...
                <div className="border-t p-4 bg-muted/30 space-y-2">
                    ...
                    <div className="flex justify-between items-center text-lg font-semibold tracking-tight pt-2 border-t">
                        <span>Total</span>
