...
const eventConfig: Record<OrderEventType, { icon: LucideIcon; color: string; bgColor: string }> = {
    ...
    order_confirmed: { icon: CheckCircle, color: "text-info", bgColor: "bg-info/10" },
    ...
    payment_authorized: { icon: CreditCard, color: "text-info", bgColor: "bg-info/10" },
    payment_captured: { icon: CreditCard, color: "text-success", bgColor: "bg-success/10" },
    payment_refunded: { icon: CreditCard, color: "text-ds-blue-700", bgColor: "bg-ds-blue-700/10" },
    ...
    fulfillment_created: { icon: Package, color: "text-info", bgColor: "bg-info/10" },
    fulfillment_approved: { icon: CheckCircle, color: "text-success", bgColor: "bg-success/10" },
    fulfillment_shipped: { icon: Truck, color: "text-ds-teal-700", bgColor: "bg-ds-teal-700/10" },
    ...
    tracking_updated: { icon: Truck, color: "text-ds-teal-700", bgColor: "bg-ds-teal-700/10" },
    invoice_generated: { icon: FileText, color: "text-info", bgColor: "bg-info/10" },
    ...
    email_sent: { icon: Mail, color: "text-info", bgColor: "bg-info/10" },
