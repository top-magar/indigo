...
const STEPS = [
  ...
  { id: "payments", label: "Set up payments", description: "Connect payment methods or enable cash on delivery", href: "/dashboard/settings/payments", icon: CreditCard, color: "text-success", bg: "bg-success/10 dark:bg-emerald-950", ring: "stroke-emerald-600" },
  ...
  { id: "domain", label: "Add a custom domain", description: "Connect your own .com or .np domain", href: "/dashboard/settings/domains", icon: Globe, color: "text-warning", bg: "bg-amber-100 dark:bg-amber-950", ring: "stroke-amber-600" },
] as const;
