...
- [x] 1. Database Schema and Types
  - [x] 1.1 Create Drizzle schema for media tables
  ...
  - [x] 1.2 Export schema and generate migration
...
- [x] 2. Core Server Actions
  - [x] 2.1 Implement uploadAsset server action
  ...
  - [x] 2.2 Implement getAssets server action
...
- [x] 4. Media Library Dashboard Page
  ...
  - [x] 4.4 Implement MediaGrid functionality (in media-library-client.tsx)
    - Responsive grid layout
    - Infinite scroll pagination
    - Empty state
    - _Requirements: 1.2, 1.3, 1.5_
  - [x] 4.5 Implement AssetCard component (in media-library-client.tsx)
    - Display thumbnail
...
- [x] 6. Upload System (implemented in media-library-client.tsx)
  - [x] 6.1 Implement upload functionality
    - File validation (type, size)
    - Track upload progress
    - Handle errors with retry
    - Support multiple files
    - _Requirements: 2.3, 2.4, 2.5, 2.6, 2.7, 2.9_
  - [x] 6.2 Implement drag-and-drop upload
...
- [x] 7. Asset Details Panel
  - [x] 7.1 Create AssetDetails component
...
- [x] 8. Folder System (implemented in actions.ts and media-library-client.tsx)
  - [x] 8.1 Implement folder server actions
    - createFolder, renameFolder, deleteFolder, getFolders in actions.ts
    - moveAssets action
    - _Requirements: 3.2, 3.6, 3.7, 3.8_
  - [x] 8.2 Implement FolderSidebar (in media-library-client.tsx)
    - Display folder tree
    - New Folder button
    - Folder navigation
...
- [x] 9. Checkpoint - Verify folders and upload
  - Test folder creation and navigation
  - Test drag-drop to folders
  - Test file upload flow
  - Ask user if questions arise

- [x] 10. Media Picker Component
  - [x] 10.1 Create MediaPicker modal
  ...
  - [x] 10.2 Create MediaPickerTrigger component
    - Create `src/components/media/media-picker-trigger.tsx`
    - Button that opens picker
    - Show selected preview
    - Export from index.ts
    - _Requirements: 6.1, 6.6_
  - [x] 10.3 Integrate with Visual Editor
    - Update image fields in `src/lib/editor/fields/` to use MediaPicker
    - Test in settings panel
    - _Requirements: 6.1, 6.6, 6.9_

- [x] 11. Bulk Operations (implemented in media-library-client.tsx and actions.ts)
  - [x] 11.1 Add multi-select to grid
    - Selection state management
    - Checkbox on hover/select
    - Select All option
    - Selection count display
    - _Requirements: 8.1, 8.5_
  - [x] 11.2 Implement BulkActionBar (in media-library-client.tsx)
    - Delete selected action
    - Progress feedback
    - _Requirements: 8.2, 8.3, 8.4, 8.6, 8.7_
  - [x] 11.3 Implement bulk server actions
    - bulkDeleteAssets, bulkMoveAssets in actions.ts
    - Handle partial failures
    - _Requirements: 8.3, 8.4, 8.7_

- [x] 12. Storage Quotas (implemented in actions.ts and media-library-client.tsx)
  - [x] 12.1 Implement storage tracking
    - getStorageUsage server action
    - Display usage in sidebar
    - _Requirements: 9.1, 9.2_
  - [x] 12.2 Add quota enforcement
